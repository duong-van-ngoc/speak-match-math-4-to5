...
const config: Phaser.Types.Core.GameConfig = {
  ...
  scale: {
    ...
    // On small screens, rounding the CSS canvas size/position can cause visible aliasing artifacts.
    autoRound: false,
  },
  render: {
    pixelArt: false,
    antialias: true,
    // On small screens, rounding sprite positions can look "broken"/jagged when downscaled.
    roundPixels: false,
  },
  // Chạy PreloadScene trước để load toàn bộ asset, rồi mới vào GameScene
  scene: [PreloadScene, GameScene, CountConnectScene, ColorScene, CircleMarkScene, EndGameScene],
};
