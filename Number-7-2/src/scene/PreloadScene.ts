...
export default class PreloadScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image('count_groups_text_sun', 'assets/text/text1.png');
    this.load.image('count_groups_text_moon', 'assets/text/text2.png');
    this.load.image('count_groups_text_rainbow', 'assets/text/text3.png');
    this.load.image('count_groups_text_star', 'assets/text/text4.png');
    this.load.image('count_groups_text_cloud', 'assets/text/text5.png');
    this.load.image('count_groups_detail_score_bar', 'assets/text/Frame 97.png');

    // =========================================================
    // ✅ Number-6 gameplay assets (PNG)
    // ========================================================
    // Direct keys for new theme (reuse vehicles pack)
    this.load.image('sun', 'assets/vehicles/image 85.png'); // mặt trời
    this.load.image('moon', 'assets/vehicles/image 86.png'); // mặt trăng
    this.load.image('rainbow', 'assets/vehicles/image 89.png'); // cầu vồng
    this.load.image('cloud', 'assets/vehicles/image 88.png'); // đám mây
    this.load.image('star', 'assets/vehicles/image 91.png'); // ngôi sao
    // CountGroupsScene vehicles (mapped to new theme)
    this.load.image('veh_sun', 'assets/vehicles/image 85.png'); // mặt trời
    this.load.image('veh_moon', 'assets/vehicles/image 86.png'); // mặt trăng
    this.load.image('veh_rainbow', 'assets/vehicles/image 89.png'); // cầu vồng
    this.load.image('veh_cloud', 'assets/vehicles/image 88.png'); // đám mây
    this.load.image('veh_star', 'assets/vehicles/image 91.png'); // ngôi sao
    // ConnectSix dice + group frames
    this.load.image('connect_six_dice', 'assets/vehicles/Frame 90.png');
    this.load.image('connect_six_group_moon_7', 'assets/vehicles/Frame 96.png');
    this.load.image('connect_six_group_cloud_5', 'assets/vehicles/Frame 93.png');
    this.load.image('connect_six_group_rainbow_4', 'assets/vehicles/Frame 95.png');
    this.load.image('connect_six_group_star_7', 'assets/vehicles/Frame 94.png');
    // Hand hint
