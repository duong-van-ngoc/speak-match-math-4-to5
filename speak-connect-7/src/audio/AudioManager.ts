...
const SOUND_MAP: Record<string, SoundConfig> = {
    ...
    'voice-intro-connect': { src: `${BASE_PATH}prompt/guide3.mp3`, volume: 1.0 },
    'voice_correct': { src: `${BASE_PATH}sfx/correct_answer.mp3`, volume: 1.0 },
    'voice_wrong': { src: `${BASE_PATH}sfx/wrong.mp3`, volume: 0.6 },
    ...
    // ---- Nature Scene Audio ----
    'voice-intro-nature': { src: `${BASE_PATH}prompt/guide4.mp3`, volume: 1.0 },
    'voice-mic-instruction': { src: `${BASE_PATH}prompt/mic.mp3`, volume: 1.0 },
    'audio_nature_1': { src: `${BASE_PATH}nature/audio_nature_1.mp3`, volume: 1.0 },
    'audio_nature_2': { src: `${BASE_PATH}nature/audio_nature_2.mp3`, volume: 1.0 },
    'audio_nature_3': { src: `${BASE_PATH}nature/audio_nature_3.mp3`, volume: 1.0 },
    'audio_nature_4': { src: `${BASE_PATH}nature/audio_nature_4.mp3`, volume: 1.0 },
    'audio_nature_5': { src: `${BASE_PATH}nature/audio_nature_5.mp3`, volume: 1.0 },
};
