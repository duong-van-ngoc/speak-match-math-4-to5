...
export const GameConstants = {
    ...
    BACKEND_SESSION: {
        ...
        LESSON_ID: 'lesson-number7-2-4-5',
        /** Game version (semver) */
        GAME_VERSION: '1.0.0',
    ...
    VOICE_RECORDING: {
        ...
        KEYWORDS: 'mặt trời, mặt trăng, cầu vồng, đám mây, ngôi sao',
        /** API endpoint để gửi audio (dùng Proxy để tránh CORS khi chạy local) */
    ...
    // =========================================
    // NATURE SCENE: Gọi tên hiện tượng thiên nhiên (5 levels)
    // =========================================
    SPEAK_SCENE: {
        ...
        // --- NATURE IMAGE (hình hiện tượng thiên nhiên - giữa màn hình) ---
        NATURE_IMAGE: {
            X: 0.5,
            Y: 0.35,
            SCALE: 1.0,
    ...
    CONNECT_SCENE: {
        ...
        GROUPS: [
            { id: 'star', label: 'ngôi sao', count: 7, spriteKey: 'nat_star', x: 260, y: 170, cols: 3 },
            { id: 'moon', label: 'mặt trăng', count: 7, spriteKey: 'nat_moon', x: 1020, y: 170, cols: 3 },
            { id: 'rainbow', label: 'cầu vồng', count: 5, spriteKey: 'nat_rainbow', x: 260, y: 560, cols: 3 },
            { id: 'cloud', label: 'đám mây', count: 4, spriteKey: 'nat_cloud', x: 1020, y: 560, cols: 2 },
        ]
    },

    // =========================================
    // NATURE CONFIG (5 hiện tượng thiên nhiên)
    // =========================================
    NATURE_PHENOMENA: {
        TOTAL_LEVELS: 5,

        // Danh sách hiện tượng thiên nhiên
        ITEMS: [
            {
                id: 'nature_1',
                name: 'Mặt trời',
                imageKey: 'nature_1',
                imagePath: 'assets/images/nature/nature_1.png',
                textKey: 'text_nature_1',
                textPath: 'assets/text/nature_1.png',
                audioKey: 'audio_nature_1',
                audioPath: 'assets/audio/nature/audio_nature_1.mp3',
            },
            {
                id: 'nature_2',
                name: 'Mặt trăng',
                imageKey: 'nature_2',
                imagePath: 'assets/images/nature/nature_2.png',
                textKey: 'text_nature_2',
                textPath: 'assets/text/nature_2.png',
                audioKey: 'audio_nature_2',
                audioPath: 'assets/audio/nature/audio_nature_2.mp3',
            },
            {
                id: 'nature_3',
                name: 'Cầu vồng',
                imageKey: 'nature_3',
                imagePath: 'assets/images/nature/nature_4.png',
                textKey: 'text_nature_3',
                textPath: 'assets/text/nature_3.png',
                audioKey: 'audio_nature_3',
                audioPath: 'assets/audio/nature/audio_nature_3.mp3',
            },
            {
                id: 'nature_4',
                name: 'Đám mây',
                imageKey: 'nature_4',
                imagePath: 'assets/images/nature/nature_3.png',
                textKey: 'text_nature_4',
                textPath: 'assets/text/nature_4.png',
                audioKey: 'audio_nature_4',
                audioPath: 'assets/audio/nature/audio_nature_4.mp3',
            },
            {
                id: 'nature_5',
                name: 'Ngôi sao',
                imageKey: 'nature_5',
                imagePath: 'assets/images/nature/nature_5.png',
                textKey: 'text_nature_5',
                textPath: 'assets/text/nature_5.png',
                audioKey: 'audio_nature_5',
                audioPath: 'assets/audio/nature/audio_nature_5.mp3',
            },
        ],

        // Audio hướng dẫn chung
        INTRO_AUDIO: 'voice-intro-nature',  // "Con hãy đọc tên hiện tượng thiên nhiên này"
        INTRO_AUDIO_PATH: 'assets/audio/prompt/guide4.mp3',
        // Audio khi hiện Mic
        MIC_AUDIO: 'voice-mic-instruction',
