...
export default class PreloadScene extends Phaser.Scene {
  ...
  preload() {
    ...
    // ========================================================
    // Direct keys for new theme
    this.load.image('mooncake', 'assets/icon/image 132.png'); // bánh trung thu
    this.load.image('carp_lantern', 'assets/icon/image 125.png'); // đèn lồng cá chép
    this.load.image('star_lantern', 'assets/icon/image 129.png'); // đèn ông sao
    this.load.image('lantern', 'assets/icon/image 127.png'); // đèn lồng
    this.load.image('paper_lantern', 'assets/icon/image 134.png'); // đèn lồng giấy xếp
    ...
    this.load.image('num_9', 'assets/number/9.png');
