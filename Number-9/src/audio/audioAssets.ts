...
export const AUDIO_ASSETS: Record<string, AudioAssetConfig> = {
  ...
  voice_count_9: { src: `${BASE_PATH}9.mp3` },

  // Stage 1: per-object paint instructions + transition into counting
  voice_stage1_paint_mooncake: { src: `${BASE_PATH}mooncake.mp3` },
  voice_stage1_paint_carp_lantern: { src: `${BASE_PATH}carp-lantern.mp3` },
  voice_stage1_paint_star_lantern: { src: `${BASE_PATH}star-lantern.mp3` },
  voice_stage1_paint_lantern: { src: `${BASE_PATH}lantern.mp3` },
  voice_stage1_paint_paper_lantern: { src: `${BASE_PATH}paper-lantern.mp3` },
