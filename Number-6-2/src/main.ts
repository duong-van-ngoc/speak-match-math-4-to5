...
function setupHtmlButtons() {
  ...
  if (replayBtn) {
    replayBtn.addEventListener("click", () => {
      ...
      // Replay modes:
      // - strict: always restart from stage 2 (+ detail) -> stage 3 -> end
...
(window as any).irukaSdk = sdk;
(window as any).irukaGame = irukaGame;
