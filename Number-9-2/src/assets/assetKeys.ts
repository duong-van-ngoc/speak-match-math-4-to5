...
export const CONNECT_SIX_ASSET_KEYS = {
  ...
  // Group images for ConnectSix (keys are English).
  groupCarpLantern: 'carp_lantern',
  groupStarLantern: 'star_lantern',
  groupLantern: 'lantern',
  groupPaperLantern: 'paper_lantern',
} as const;
