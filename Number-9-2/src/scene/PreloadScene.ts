...
export default class PreloadScene extends Phaser.Scene {
  ...
  preload() {
    ...
    // ========================================================
    // ConnectSix dice + group images
    this.load.image('connect_six_dice', 'assets/vehicles/Frame 90.png');
    this.load.image('carp_lantern', 'assets/vehicles/Frame 103.png'); // đèn lồng cá chép
    this.load.image('star_lantern', 'assets/vehicles/Frame 104.png'); // đèn ông sao
    this.load.image('lantern', 'assets/vehicles/Frame 105.png'); // đèn lồng
    this.load.image('paper_lantern', 'assets/vehicles/Frame 106.png'); // đèn lồng giấy xếp
    // Hand hint
