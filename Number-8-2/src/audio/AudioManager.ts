...
class AudioManager {
  ...
  playStage2IntroSequence(): Promise<void> {
    return this.playSequence(
      [
        'voice_stage2_guide',
        'voice_stage2_tap_watermelon',
        'voice_stage2_tap_square_cake',
        'voice_stage2_tap_red_packet',
        'voice_stage2_tap_lantern',
        'voice_stage2_tap_sticky_roll',
  ...
  playStageGuide(stage: 0 | 1): void {
    const id = stage === 0 ? 'voice_stage2_guide' : 'voice_stage3_guide';
