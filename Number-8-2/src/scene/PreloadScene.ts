...
export default class PreloadScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image('count_groups_text_watermelon', 'assets/text/text1.png');
    this.load.image('count_groups_text_square_cake', 'assets/text/text2.png');
    this.load.image('count_groups_text_red_packet', 'assets/text/text3.png');
    this.load.image('count_groups_text_lantern', 'assets/text/text4.png');
    this.load.image('count_groups_text_sticky_roll', 'assets/text/text5.png');
    ...
    this.load.image('veh_watermelon', 'assets/vehicles/watermelon.png');
    this.load.image('veh_square_cake', 'assets/vehicles/squareCake.png');
    this.load.image('veh_red_packet', 'assets/vehicles/red.png');
    this.load.image('veh_lantern', 'assets/vehicles/lantern.png');
    this.load.image('veh_sticky_roll', 'assets/vehicles/stickyRoll.png');
    ...
    this.load.image('connect_six_group_sticky_roll_6', 'assets/vehicles/Frame 98.png');
    this.load.image('connect_six_group_square_cake_5', 'assets/vehicles/Frame 100.png');
    this.load.image('connect_six_group_lantern_6', 'assets/vehicles/Frame 102.png');
    this.load.image('connect_six_group_red_packet_4', 'assets/vehicles/Frame 108.png');
    // Hand hint
