...
import { ensureBgmStarted, sdk } from "../gameContext";
...
export default class EndGameScene extends Phaser.Scene {
    ...
    preload() {
        loadAssetGroups(this, 'endScene', 'ui');
    }
    ...
    create() {
        ...
        replayBtn.on('pointerdown', () => {
            ...
            // Dừng tất cả các scene liên quan
            const scenesToStop = [
                'GameSceneBoat',
                'CountConnectScene',
                'ColorSceneBoat',
            ...
            scenesToStop.forEach(s => {
                this.scene.get(s)?.scene.stop();
            });

            // Start lại GameSceneBoat hoàn toàn mới
            this.scene.start('GameSceneBoat');
            ensureBgmStarted();
        });
        ...
        // Hiển thị lại nút chơi lại ở góc trên bên phải
