...
const SOUND_MAP: Record<string, SoundConfig> = {
  ...
  // Audio hướng dẫn (game31..35 map theo bộ ảnh Question (6)..(10))
  // Q6: tô xanh thuyền, Q7: tô đỏ khinh khí cầu đỏ, Q8: tô vàng khinh khí cầu vàng, Q9: đếm khinh khí cầu và nối, Q10: khoanh thuyền rồi nối.
  voice_guide_21: { src: `${BASE_PATH}game33.mp3`, volume: 0.8 }, // Color 1 (khinh khí cầu vàng) -> Q8
  voice_guide_22: { src: `${BASE_PATH}game32.mp3`, volume: 0.8 }, // Color 2 (khinh khí cầu đỏ) -> Q7
  voice_guide_23: { src: `${BASE_PATH}game31.mp3`, volume: 0.8 }, // Color 3 (thuyền - tô xanh) -> Q6
  voice_guide_24: { src: `${BASE_PATH}game35.mp3`, volume: 0.8 }, // Circle -> Q10
  voice_guide_25: { src: `${BASE_PATH}game34.mp3`, volume: 0.8 }, // Count -> Q9
  voice_guide_26: { src: `${BASE_PATH}game34.mp3`, volume: 0.8 },
...
class AudioManager {
  ...
  play(id: string): number | undefined {
    ...
    // Nếu đang phát voice hướng dẫn mà bé spam/click nhanh để trả lời đúng/sai,
    // ưu tiên ngắt voice hướng dẫn để tránh lồng tiếng.
    if (id === 'sfx_correct' || id === 'sfx_wrong' || id.startsWith('correct_answer_')) {
      this.stopGuideVoices();
    }
