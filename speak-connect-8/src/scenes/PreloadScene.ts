...
export default class PreloadScene extends Phaser.Scene {
    ...
    preload() {
        ...
        // ========================================
        // 3. VehicleScene Assets (Đồ vật ngày Tết)
        // ========================================
        ...
        // Load hình ảnh đồ vật và chữ đi kèm từ config
        const TET_ITEMS = GameConstants.TET_ITEMS;
        TET_ITEMS.ITEMS.forEach((item) => {
        ...
        // ========================================
        // Board & Banner
        this.load.image(TextureKeys.Connect_Board, 'assets/images/bg/board_scene_2.png');
        this.load.image(TextureKeys.Connect_TopBanner, 'assets/connectScene/banner.png');

        // Tet items objects (Using specific ConnectScene assets)
        this.load.image(TextureKeys.Connect_Veh_SquareCake, 'assets/connectScene/squareCake.png');
        this.load.image(TextureKeys.Connect_Veh_Red, 'assets/connectScene/red.png');
        this.load.image(TextureKeys.Connect_Veh_Lantern, 'assets/connectScene/lantern.png');
        this.load.image(TextureKeys.Connect_Veh_StickyRoll, 'assets/connectScene/stickyRoll.png');

        this.load.image(TextureKeys.Connect_Dice, 'assets/connectScene/placeholder.png');
        this.load.image(TextureKeys.Connect_Marker, 'assets/connectScene/placeholder.png');
    }
