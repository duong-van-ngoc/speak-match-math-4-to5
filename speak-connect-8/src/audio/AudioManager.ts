...
const SOUND_MAP: Record<string, SoundConfig> = {
    ...
    'audio_watermelon': { src: `${BASE_PATH}tet_items/watermelon.mp3`, volume: 1.0 },
    'audio_squareCake': { src: `${BASE_PATH}tet_items/squareCake.mp3`, volume: 1.0 },
    'audio_red': { src: `${BASE_PATH}tet_items/red.mp3`, volume: 1.0 },
    'audio_lantern': { src: `${BASE_PATH}tet_items/lantern.mp3`, volume: 1.0 },
    'audio_stickyRoll': { src: `${BASE_PATH}tet_items/stickyRoll.mp3`, volume: 1.0 },
};
