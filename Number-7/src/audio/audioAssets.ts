...
export const AUDIO_ASSETS: Record<string, AudioAssetConfig> = {
  ...
  voice_stage1_paint_car: { src: `${BASE_PATH}sun1.mp3` },
  voice_stage1_paint_bicycle: { src: `${BASE_PATH}moon1.mp3` },
  voice_stage1_paint_airplane: { src: `${BASE_PATH}rainbow1.mp3` },
  voice_stage1_paint_boat: { src: `${BASE_PATH}cloud1.mp3` },
  voice_stage1_paint_scooter: { src: `${BASE_PATH}star1.mp3` },
