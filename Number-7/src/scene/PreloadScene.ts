...
export default class PreloadScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image('sun', 'assets/icon/image 85.png'); // mặt trời
    this.load.image('moon', 'assets/icon/image 86.png'); // mặt trăng
    this.load.image('rainbow', 'assets/icon/image 89.png'); // cầu vồng
    this.load.image('cloud', 'assets/icon/image 88.png'); // đám mây
    this.load.image('star', 'assets/icon/image 91.png'); // ngôi sao
