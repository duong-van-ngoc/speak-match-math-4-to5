...
export default class VehicleScene extends SceneBase {
    ...
    protected createUI(): void {
        ...
        const firstVehicle = GameConstants.VEHICLES.ITEMS[0];
        ...
        this.vehicleImage = this.add.image(
            ...
            h * CFG.VEHICLE_IMAGE.Y + 20, // Dịch xuống 1 chút
        ...
        this.tweens.add({
            ...
            y: (h * CFG.VEHICLE_IMAGE.Y + 20) - CFG.ANIM.FLOAT_DISTANCE,
    ...
    private async goToNextLevel(): Promise<void> {
        ...
        if (this.currentLevel >= GameConstants.VEHICLES.TOTAL_LEVELS) {
