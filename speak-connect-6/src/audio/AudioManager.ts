...
const SOUND_MAP: Record<string, SoundConfig> = {
    ...
    // ---- Vehicle Scene Audio ----
    'intro-vehicle': { src: `${BASE_PATH}prompt/guide4.mp3`, volume: 1.0 },
    'mic-vehicle': { src: `${BASE_PATH}prompt/mic.mp3`, volume: 1.0 },
    'audio_vehicle_1': { src: `${BASE_PATH}vehicles/audio_vehicle_1.mp3`, volume: 1.0 },
    'audio_vehicle_2': { src: `${BASE_PATH}vehicles/audio_vehicle_2.mp3`, volume: 1.0 },
    'audio_vehicle_3': { src: `${BASE_PATH}vehicles/audio_vehicle_3.mp3`, volume: 1.0 },
    'audio_vehicle_4': { src: `${BASE_PATH}vehicles/audio_vehicle_4.mp3`, volume: 1.0 },
    'audio_vehicle_5': { src: `${BASE_PATH}vehicles/audio_vehicle_5.mp3`, volume: 1.0 },
};
